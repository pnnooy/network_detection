...
| **Phase 5** | PPT、演示视频、结题报告 | 7/28 ~ 8/1 | 🔴 进行中 |
| **内部预演** | 完整走一遍汇报流程 | 7/28 | ✅ 已完成 |
| **项目汇报** | 课堂分享汇报 | 7/29 | 🔴 明天 |
| **结题报告** | 结题报告撰写 + 源码整理 | 7/28 ~ 8/1 | 🔴 进行中 |
| **提前提交** | 源码 + 结题报告打包提交 | 8/2 | — |
| **缓冲** | 应对意外问题 | 8/3 ~ 8/4 | — |
| **官方截止** | 结题报告提交截止 | 8/5 | — |

> **Phase 4 完成**（7/27）：跨机器演示环境已搭建并验证通过。Kali VM 攻击 → Windows Npcap 抓包 → 1,560 条真实流量 → 18 条告警。Web Mock/Live 双模式、`--watch` 持续检测、攻击菜单已就绪。
...
| 7/29(二) | ★ **项目分享汇报** | 🔴 明天 |
| 7/29(二) ~ 8/1(五) | 结题报告审校 + 源码整理 | 🔴 进行中 |
| 8/2(六) | 🏁 **提前提交**（比 8/5 截止早 3 天） | — |
| 8/3(日) ~ 8/4(一) | 缓冲（应对意外） | — |
| 8/5(二) | 📅 官方截止，确认提交无误 | — |
...
### 第 4 周（7/25 — 7/29）：演示环境 + PPT + 报告 + 答辩
...
> **文档维护者**：韩宇飞（组长）
> **最后更新**：2026-07-28（新增开发历程/教师建议落实/踩坑记录；PPT大纲+报告分工文档就绪；目录更新）
